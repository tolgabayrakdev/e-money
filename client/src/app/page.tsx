                ...
                changeVisible ?
                  <form onSubmit={handleLogin}>
                    <div className="flex flex-col">
                      ...
                      {
                        openSecondSnackbar ? <p className="text-center text-red-600 w-52">Error, check your email or password!</p> : ""
                      }
                  ...
                  <form onSubmit={handleRegister}>
                    <div className="flex flex-col">
                      ...
                      {
                        createdSnackbar ? <p className="text-center text-green-500 w-52">Account created succesful. You are redirected to login page... </p> :
                          <section className="flex flex-col"> <input onChange={(e) => setUsername(e.target.value)} type="text" name="username" id="useranem" placeholder="Username" className=" border-2 p-1 rounded-md border-blue-400 mb-1" />
