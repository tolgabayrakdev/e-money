        ...
        <section>
                    ...
                    >
                        <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                            <p
                                ...
                                className="font-medium text-gray-600 underline hover:cursor-pointer hover:text-gray-300 dark:text-gray-400 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            >
                                Log out
                            </p>
                        </div>
            ...
            <div className="flex h-48">
                <div className="container p-6 border">
                    <h3 className="text-center text-xl underline italic text-gray-800 hover:text-gray-700">
                        User Information
                    </h3>
                ...
                <div className=" container p-6 border">
                    <h3 className="text-center underline text-xl italic text-gray-800 hover:text-gray-700">
                        Account
                    </h3>
                    {accounts.map((account) => (
                        <div key={account.id} className="border p-3 rounded-md">
                            ...
                            <p>
                                type_id:{' '}
                                {account.account_type_id == 1 ? 'personal' : ''}{' '}
                            </p>
            ...
            <div className="border p-6 text-center h-[40rem]">{children}</div>
            <footer>
